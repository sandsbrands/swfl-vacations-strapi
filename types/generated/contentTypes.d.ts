...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    booking_source: Schema.Attribute.String;
    ...
    guest_first_name: Schema.Attribute.String;
    guest_last_name: Schema.Attribute.String;
...
export interface ApiExperienceBookingExperienceBooking
  extends Struct.CollectionTypeSchema {
  collectionName: 'experience_bookings';
  info: {
    displayName: 'Experience_Booking';
    pluralName: 'experience-bookings';
    singularName: 'experience-booking';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience-booking.experience-booking'
    > &
      Schema.Attribute.Private;
    number_of_guests: Schema.Attribute.Integer;
    payout_schedule_date: Schema.Attribute.Date;
    payout_status: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    stripe_payment_intent_id: Schema.Attribute.String;
    total_amount: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vendor_payout_amount: Schema.Attribute.Integer;
  };
}
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    price_per_person: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOwnerOwner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    qbo_customer_id: Schema.Attribute.String;
...
export interface ApiPropertyImagePropertyImage
  extends Struct.CollectionTypeSchema {
  collectionName: 'property_images';
  info: {
    displayName: 'Property_Image';
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    payout_percentage: Schema.Attribute.Integer;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    stripe_connect_account_id: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
